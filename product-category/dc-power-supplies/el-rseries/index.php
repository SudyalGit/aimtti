        ...
        <div class="content">
            ...
            <div class="product-card">
                ...
                <div class="product-card-details">
                    <ul>
                        <li>Single outputs, 30V/1A, 18V/3.3A, 56V/1.1A, 15V/5A, 30V/3A</li>
                        <li>Single, dual or triple outputs, 30V/2A</li>
                        ...
                        <li>Variable 1.5 - 5.0V auxiliary output at 2A (EL302RT)</li>
                        <li>Compact design uses less bench space</li>
                        <li>Silent fan-free cooling</li>
                        <li>DC output switches, automatic mode indication</li>
                        <li>RS232 or USB controlled models available (30V/2A single)</li>
                    </ul>
                    <br>
                ...
                <div id="model-title-data" class="data-table hide">
                    ...
                    <table class="views-table cols-0">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <a href="/resources/el-r-series-instruction-manual-issue-6">EL-R Series Instruction Manual - Issue 6 - (PDF / English)</a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <a href="/resources/el302p-instruction-manual-issue-11">EL302P Instruction Manual - Issue 11 - (PDF / English)</a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <a href="/resources/el302p-usb-instruction-manual-issue-7">EL302P-USB Instruction Manual - Issue 7 - (PDF / English)</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
