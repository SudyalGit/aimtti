...
$title = "PFM3000 Handheld 3GHz Freqency Counter | Aim-TTi India India";
$heading = "PFM3000";

$sql = "SELECT * FROM `productmodels` WHERE `ProductId` = 21";
...
$sql = "SELECT * FROM `productmodels` WHERE `ImageURL` = 'access' AND ModelName = 'PFM-SC'";
$result = mysqli_query($conn, $sql);
...
<head>
    ...
    <meta name="description" content="Aim-TTi PFM3000 Handheld 3GHz Freqency Counter" />
    <link rel="canonical" href="https://aimtti.co.in/product-category/frequency-counters/aim-pfm3000" />
    <title>PFM3000 Handheld 3GHz Freqency Counter | Aim-TTi India</title>
        ...
        <div class="content">
            ...
            <div class="product-card">
                <div class="product-card-carousel">
                    <div class="container">
                        <div class="mySlides">
                            <img class="model-for-image cursor" data-img="<?php echo $domain ?>sites/default/files/image/large/" src="<?php echo $domain ?>sites/default/files/styles/product_medium/public/image/large/AIM-PFM3000-1k_0.jpg?itok=-ur4QOyu" alt="">
                        </div>

                        <div class="mySlides">
                            <img class="model-for-image cursor" data-img="<?php echo $domain ?>sites/default/files/image/large/" src="<?php echo $domain ?>sites/default/files/styles/product_medium/public/image/large/AIM-PFM3000-stand-1k.jpg?itok=BZcgbK0t" alt="">
                        </div>

                        <div class="mySlides">
                            <img class="model-for-image cursor" data-img="<?php echo $domain ?>sites/default/files/image/large/" src="<?php echo $domain ?>sites/default/files/styles/product_medium/public/image/large/AIM-PFM3000-flat-1k.jpg?itok=plhYfDkf" alt="">
                        </div>
                        ...
                        <div class="row">
                            <div class="column">
                                <img class="demo cursor" src="<?php echo $domain ?>sites/default/files/styles/product_medium/public/image/large/AIM-PFM3000-1k_0.jpg?itok=-ur4QOyu" style="width:100%" onclick="currentSlide(1)" alt="">
                            </div>
                            <div class="column">
                                <img class="demo cursor" src="<?php echo $domain ?>sites/default/files/styles/product_medium/public/image/large/AIM-PFM3000-stand-1k.jpg?itok=BZcgbK0t" style="width:100%" onclick="currentSlide(2)" alt="">
                            </div>
                            <div class="column">
                                <img class="demo cursor" src="<?php echo $domain ?>sites/default/files/styles/product_medium/public/image/large/AIM-PFM3000-flat-1k.jpg?itok=plhYfDkf" style="width:100%" onclick="currentSlide(3)" alt="">
                            </div>
                ...
                <div class="product-card-details">
                    <ul>
                        <li>3 Hz to 3000 MHz in two overlapping ranges</li>
                        <li>High input sensitivity over the full frequency range</li>
                        <li>High impedance measurement up to 125 MHz</li>
                        <li>Reciprocal counting technique gives superior resolution</li>
                        <li>Period measurement from 3 Hz to 125 MHz</li>
                        <li>Battery operation and lightweight, handheld format</li>
                        <li>Push-to-measure function with auto power-down</li>
                        <li>Large 8+ digit display with full range of annunciators</li>
                ...
                <div id="model-title-data" class="data-table hide">
                    ...
                    <table class="views-table cols-0">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <a href="/resources/pfm3000-instruction-manual-issue-4">PFM3000 Instruction Manual - Issue 4 - (PDF / English, French, German, Italian, Spanish)</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
