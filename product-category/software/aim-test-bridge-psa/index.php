...
$title = "Test Bridge PSA Software for Aim-TTi PSA Series Spectrum Analyzers | Aim-TTi India India";
$heading = "Test Bridge PSA";

$sql = "SELECT * FROM `productmodels` WHERE `ProductId` = 33";
...
<head>
    ...
    <meta name="description" content="Aim-TTi Test Bridge PSA Software for Aim-TTi PSA Series Spectrum Analyzers" />
    <link rel="canonical" href="https://aimtti.co.in/product-category/software/aim-test-bridge-psa" />
    <title>Test Bridge PSA Software for Aim-TTi PSA Series Spectrum Analyzers | Aim-TTi India</title>
        ...
        <div class="content">
            ...
            <div class="product-card">
                <div class="product-card-carousel">
                    <div class="container">
                        <div class="mySlides">
                            <img class="model-for-image cursor" data-img="<?php echo $domain ?>sites/default/files/image/large/" src="<?php echo $domain ?>sites/default/files/styles/product_medium/public/image/large/AIM-TB-PSA-laptop.jpg?itok=lZH4lG_Y" alt="">
                        </div>
                        ...
                        <div class="row">
                            <div class="column">
                                <img class="demo cursor" src="<?php echo $domain ?>sites/default/files/styles/product_medium/public/image/large/AIM-TB-PSA-laptop.jpg?itok=lZH4lG_Y" style="width:100%" onclick="currentSlide(1)" alt="">
                            </div>
                ...
                <div class="product-card-details">
                    <div class="field-item even">
                        <p>Test Bridge PSA software is a free Windows application for use with the Aim-TTi PSA Series spectrum analyzers. It works with PSA Series 2, 3 or 5 (the series is indicated by the last digit of the model number) and requires option U01 (PSA Series 2 and 3) or option U02 (PSA Series 5) to be installed.&nbsp; Analyzers purchased as a kit with the USC suffix (e.g., PSA6005USC) have the relevant option factory installed.&nbsp;</p>

                        <p><a href="https://www.aimtti.com/resources/test-bridge-psa-software" title="Link to the download page for this software"><strong>DOWNLOAD</strong></a> - link to the download page for this software</p>
                    </div>
                </div>
            </div>
