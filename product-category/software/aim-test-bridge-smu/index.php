...
$title = "Test Bridge SMU Automation and control software for Aim-TTi SMU4000 Series. | Aim-TTi India India";
$heading = "Test Bridge SMU";

$sql = "SELECT * FROM `productmodels` WHERE `ProductId` = 32";
...
<head>
    ...
    <meta name="description" content="Aim-TTi Test Bridge SMU Automation and control software for Aim-TTi SMU4000 Series." />
    <link rel="canonical" href="https://aimtti.co.in/product-category/software/aim-test-bridge-smu" />
    <title>Test Bridge SMU Automation and control software for Aim-TTi SMU4000 Series. | Aim-TTi India</title>
        ...
        <div class="content">
            ...
            <div class="product-card">
                <div class="product-card-carousel">
                    <div class="container">
                        <div class="mySlides">
                            <img class="model-for-image cursor" data-img="<?php echo $domain ?>sites/default/files/image/large/" src="<?php echo $domain ?>sites/default/files/styles/product_medium/public/image/large/Test_Bridge_SMU_screen_0.png?itok=BVBvawO5" alt="">
                        </div>
                        ...
                        <div class="row">
                            <div class="column">
                                <img class="demo cursor" src="<?php echo $domain ?>sites/default/files/styles/product_medium/public/image/large/Test_Bridge_SMU_screen_0.png?itok=BVBvawO5" style="width:100%" onclick="currentSlide(1)" alt="">
                            </div>
                ...
                <div class="product-card-details">
                    <div class="field-item even">
                        <p>Test Bridge SMU software is a free Windows application for controlling and managing results from the Aim-TTi SMU4000 Series.&nbsp;</p>

                        <p><a href="https://www.aimtti.com/resources/test-bridge-smu-software" title="Link to the download page for this software"><strong>DOWNLOAD</strong></a> - link to the download page for this software</p>
                    </div>
                </div>
            </div>
                ...
                <div id="model-title-data" class="data-table hide">
                    <table class="views-table cols-0">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <a href="/resources/test-bridge-smu-user-manual">Test Bridge SMU User Manual - (PDF / English)</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
