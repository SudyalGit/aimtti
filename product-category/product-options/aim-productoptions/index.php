...
$title = "Product Options | Aim-TTi India India";
$heading = "Product Options";

$sql = "SELECT * FROM `productmodels` WHERE `ProductId` = 40";
...
<head>
    ...
    <meta name="description" content="Aim-TTi Product Options Product Options" />
    <link rel="canonical" href="https://aimtti.co.in/product-category/product-options/aim-productoptions" />
        ...
        <div class="content">
            ...
            <div class="product-card">
                <div class="product-card-carousel">
                    <div class="container">
                        <div class="mySlides">
                            <img class="model-for-image cursor" data-img="<?php echo $domain ?>sites/default/files/image/large/" src="<?php echo $domain ?>sites/default/files/styles/product_medium/public/image/large/tg-gpib-295.jpg?itok=xDjcGpBg" alt="">
                        </div>
                        ...
                        <div class="row">
                            <div class="column">
                                <img class="demo cursor" src="<?php echo $domain ?>sites/default/files/styles/product_medium/public/image/large/tg-gpib-295.jpg?itok=xDjcGpBg" style="width:100%" onclick="currentSlide(1)" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="product-card-details">
                    <div class="field-item even">
                        <p>Most options are specified at the time of ordering, but the items listed here can be retro-fitted.</p>

                        <p>To find out if the option is applicable to a particular product, please see the "Options &amp; Accessories" tab of the product in question where all the applicable options should be listed.</p>
                    </div>
                </div>
            </div>
