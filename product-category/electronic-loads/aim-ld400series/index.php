...
$title = "LD400 Series Electronic DC Load, 80V, 80A, 400W | Aim-TTi India India";
$heading = "LD400 Series";

$sql = "SELECT * FROM `productmodels` WHERE `ProductId` = 10";
...
<head>
    ...
    <meta name="description" content="Aim-TTi LD400 Series Electronic DC Load, 80V, 80A, 400W with/without Remote Interfaces" />
    <link rel="canonical" href="https://aimtti.co.in/product-category/electronic-loads/aim-ld400series" />
    <title>LD400 Series Electronic DC Load, 80V, 80A, 400W | Aim-TTi India</title>
        ...
        <div class="content">
            ...
            <div class="product-card">
                <div class="product-card-carousel">
                    <div class="container">
                        <div class="mySlides">
                            <img class="model-for-image cursor" data-img="<?php echo $domain ?>sites/default/files/image/large/" src="<?php echo $domain ?>sites/default/files/styles/product_medium/public/image/large/AIM-LD400-1k.jpg?itok=dGOslaFJ" alt="">
                        </div>

                        <div class="mySlides">
                            <img class="model-for-image cursor" data-img="<?php echo $domain ?>sites/default/files/image/large/" src="<?php echo $domain ?>sites/default/files/styles/product_medium/public/image/large/AIM-Test_Bridge-1000px_6.png?itok=4SheURBW" alt="">
                        </div>
                        ...
                        <div class="row">
                            <div class="column">
                                <img class="demo cursor" src="<?php echo $domain ?>sites/default/files/styles/product_medium/public/image/large/AIM-LD400-1k.jpg?itok=dGOslaFJ" style="width:100%" onclick="currentSlide(1)" alt="">
                            </div>
                            <div class="column">
                                <img class="demo cursor" src="<?php echo $domain ?>sites/default/files/styles/product_medium/public/image/large/AIM-Test_Bridge-1000px_6.png?itok=4SheURBW" style="width:100%" onclick="currentSlide(2)" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="product-card-details">
                    <ul>
                        <li>Versatile solution for testing dc power sources</li>
                        <li>Constant current, resistance, conductance, voltage and power modes</li>
                        <li>Wide voltage and current range, 0 to 80V and 0 to 80A</li>
                        <li>400 watts continuous dissipation at 28°C (360W at 40°C)</li>
                        <li>600 watts short-term dissipation (up to 60 seconds)</li>
                        <li>Low minimum operating voltage of &lt;1V at 40A</li>
                        ...
                        <li>Front and rear input terminals (front terminals 30A max.)</li>
                        <li>Full bus control via USB, RS232 and LXI compliant LAN interfaces (LD400P)</li>
                        <li>GPIB option (LD400P only)</li>
                    </ul>
                    <br>
                ...
                <div id="model-title-data" class="data-table hide">
                    <table class="views-table cols-0">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <a href="/resources/ld400-electronic-load-product-tour">LD400 Electronic Load Product Tour - (HTML / English)</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    <table class="views-table cols-0">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <a href="/resources/ld400p-firmware-files-v109v106">LD400P firmware files V1.09/V1.06 - (HEX / English)</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="views-table cols-0">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <a href="/resources/ld400-ld400p-bedienungsanleitung-auf-deutsch-issue-8">LD400 &amp; LD400P Bedienungsanleitung auf Deutsch - Issue 8 - (PDF / German)</a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <a href="/resources/ld400-ld400p-instrucciones-en-espanol-issue-8">LD400 &amp; LD400P Instrucciones en Espanol - Issue 8 - (PDF / Spanish)</a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <a href="/resources/ld400-ld400p-instruction-manual-issue-8">LD400 &amp; LD400P Instruction Manual - Issue 8 - (PDF / English)</a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <a href="/resources/ld400-ld400p-instructions-en-francais-issue-8">LD400 &amp; LD400P Instructions en Francais - Issue 8 - (PDF / French)</a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <a href="/resources/ld400-ld400p-istruzioni-italiano-issue-8">LD400 &amp; LD400P Istruzioni in Italiano - Issue 8 - (PDF / Italian)</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
