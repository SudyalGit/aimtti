...
$title = "TG1006 10MHz DDS Function Generator with Counter | Aim-TTi India India";
$heading = "TG1006";

$sql = "SELECT * FROM `productmodels` WHERE `ProductId` = 17";
...
<head>
    ...
    <meta name="description" content="Aim-TTi TG1006 10MHz DDS Function Generator with Counter" />
    <link rel="canonical" href="https://aimtti.co.in/product-category/function-generators/aim-tg1006" />
    <title>TG1006 10MHz DDS Function Generator with Counter | Aim-TTi India</title>
        ...
        <div class="content">
            ...
            <div class="product-card">
                <div class="product-card-carousel">
                    <div class="container">
                        <div class="mySlides">
                            <img class="model-for-image cursor" data-img="<?php echo $domain ?>sites/default/files/image/large/" src="<?php echo $domain ?>sites/default/files/styles/product_medium/public/image/large/AIM-TG1006-1k.png?itok=zkUwJvIK" alt="">
                        </div>
                        ...
                        <div class="row">
                            <div class="column">
                                <img class="demo cursor" src="<?php echo $domain ?>sites/default/files/styles/product_medium/public/image/large/AIM-TG1006-1k.png?itok=zkUwJvIK" style="width:100%" onclick="currentSlide(1)" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="product-card-details">
                    <ul>
                        <li>0.001Hz to 10MHz frequency range</li>
                        ...
                        <li>Unique manual sweep gives quasi-analogue control</li>
                        <li>AM and FSK modes, frequency list (10 steps)</li>
                        <li>2mV to 20V pk-pk from 50 or 600 Ohms</li>
                        <li>Built-in seven digit 120MHz frequency counter</li>
                        <li>Low cost</li>
                    </ul>
                    <br>
                    <div> <span><a href="https://resources.aimtti.com/datasheets/AIM-TG1006_function_generator_data_sheet-Iss1A.pdf" title="Link to this datasheet/brochure (opens in a new window or tab)" target="_blank"><img class="file-icon" alt="" title="application/pdf" src="<?php echo $domain ?>application-pdf.png"> Datasheet </a> - (PDF / English)</span> </div>
                </div>
            </div>
                ...
                <div id="model-title-data" class="data-table hide">
                    <table class="views-table cols-0">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <a href="/resources/tg1006-function-generator-data-sheet">TG1006 function generator data sheet - (PDF / English)</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    <table class="views-table cols-0">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <a href="/resources/tg1006-bedienungsanleitung-auf-deutsch-issue-7">TG1006 Bedienungsanleitung auf Deutsch - Issue 7 - (PDF / German)</a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <a href="/resources/tg1006-instrucciones-en-espanol-issue-7">TG1006 Instrucciones en Espanol - Issue 7 - (PDF / Spanish)</a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <a href="/resources/tg1006-instruction-manual-english-issue-7">TG1006 Instruction Manual-English - Issue 7 - (PDF / English)</a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <a href="/resources/tg1006-instructions-en-francais-issue-7">TG1006 Instructions en Francais - Issue 7 - (PDF / French)</a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <a href="/resources/tg1006-istruzioni-italiano-issue-7">TG1006 Istruzioni in Italiano - Issue 7 - (PDF / Italian)</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
