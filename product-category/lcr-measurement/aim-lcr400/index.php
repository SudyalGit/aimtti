...
$title = "LCR400 Precision LCR Meter with Component Fixture and Limits Comparator | Aim-TTi India India";
$heading = "LCR400";

$sql = "SELECT * FROM `productmodels` WHERE `ProductId` = 23";
...
$sql = "SELECT * FROM `productmodels` WHERE `ImageURL` = 'access' AND (ModelName = 'LCR-BNC' OR ModelName = 'LCR-Kclip' OR ModelName = 'LCR-SMD')";
$result = mysqli_query($conn, $sql);
...
<head>
    ...
    <meta name="description" content="Aim-TTi LCR400 Precision LCR Meter with Component Fixture and Limits Comparator" />
    <link rel="canonical" href="https://aimtti.co.in/product-category/lcr-measurement/aim-lcr400" />
    <title>LCR400 Precision LCR Meter with Component Fixture and Limits Comparator | Aim-TTi India</title>
        ...
        <div class="content">
            ...
            <div class="product-card">
                <div class="product-card-carousel">
                    <div class="container">
                        <div class="mySlides">
                            <img class="model-for-image cursor" data-img="<?php echo $domain ?>sites/default/files/image/large/" src="<?php echo $domain ?>sites/default/files/styles/product_medium/public/image/large/lcr400-1k.jpg?itok=1Z-3JnqY" alt="">
                        </div>
                        ...
                        <div class="row">
                            <div class="column">
                                <img class="demo cursor" src="<?php echo $domain ?>sites/default/files/styles/product_medium/public/image/large/lcr400-1k.jpg?itok=1Z-3JnqY" style="width:100%" onclick="currentSlide(1)" alt="">
                            </div>
                ...
                <div class="product-card-details">
                    <ul>
                        <li>0.1% basic measurement accuracy</li>
                        <li>Dual 5 digit high brightness displays</li>
                        <li>Automatic component recognition</li>
                        <li>Built-in 4 terminal component fixture</li>
                        <li>Limits comparator with 8 Pass bins plus 2 Fail bins</li>
                        <li>Three test frequencies, switchable bias</li>
                        <li>RS232 interface standard</li>
                        <li>Optional SMD tweezers, BNC connectors, Kelvin Clip test lead set, and PC logging software</li>
                    </ul>
                    <br>
                    <div> <span><a href="https://resources.aimtti.com/datasheets/AIM-LCR400_LCR_Meter_Data_Sheet_EN_82100-1050-3.pdf" title="Link to this datasheet/brochure (opens in a new window or tab)" target="_blank"><img class="file-icon" alt="" title="application/pdf" src="<?php echo $domain ?>application-pdf.png"> Datasheet </a> - (PDF / English)</span> </div>
                </div>
            </div>
                ...
                <div id="model-title-data" class="data-table hide">
                    <table class="views-table cols-0">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <a href="/resources/lcr400-lcr-meter-data-sheet-en-issue-3">LCR400 LCR Meter Data Sheet EN Issue 3 - (PDF / English)</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    <table class="views-table cols-0">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <a href="/resources/lcr400-instruction-manual-issue-10">LCR400 Instruction Manual - Issue 10 - (PDF / English)</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
