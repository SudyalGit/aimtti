...
$title = "Antennas | Aim-TTi India India";
$heading = "Antennas";

$sql = "SELECT * FROM `productmodels` WHERE `ProductId` = 35";
...
<head>
    ...
    <meta name="description" content="Aim-TTi Antennas RF Antennas for Aim-TTi instruments" />
    <link rel="canonical" href="https://aimtti.co.in/product-category/product-accessories/aim-antennas" />
    <title>Antennas | Aim-TTi India</title>
        ...
        <div class="content">
            ...
            <div class="product-card">
                <div class="product-card-carousel">
                    <div class="container">
                        <div class="mySlides">
                            <img class="model-for-image cursor" data-img="<?php echo $domain ?>sites/default/files/image/large/" src="<?php echo $domain ?>sites/default/files/styles/product_medium/public/image/large/psa-ant2-295_0.jpg?itok=II3w3QQ2" alt="">
                        </div>
                        ...
                        <div class="row">
                            <div class="column">
                                <img class="demo cursor" src="<?php echo $domain ?>sites/default/files/styles/product_medium/public/image/large/psa-ant2-295_0.jpg?itok=II3w3QQ2" style="width:100%" onclick="currentSlide(1)" alt="">
                            </div>
                ...
                <div class="product-card-details">
                    ...
                    <div> <span><a href="https://resources.aimtti.com/datasheets/PSA-ANT2_Info_Sheet.pdf" title="Link to this datasheet/brochure (opens in a new window or tab)" target="_blank"><img class="file-icon" alt="" title="application/pdf" src="<?php echo $domain ?>application-pdf.png"> Datasheet </a> - (PDF / English)</span> </div>
                </div>
            </div>
                ...
                <div id="model-title-data" class="data-table hide">
                    <table class="views-table cols-0">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <a href="/resources/psa-antenna-info-sheet">PSA Antenna Info Sheet - (PDF / English)</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
