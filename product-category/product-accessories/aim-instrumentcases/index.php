...
$title = "Instrument Cases | Aim-TTi India India";
$heading = "Instrument Cases";

$sql = "SELECT * FROM `productmodels` WHERE `ProductId` = 38";
...
<head>
    ...
    <meta name="description" content="Aim-TTi Instrument Cases Protective cases for portability and transport are available for some Aim-TTi products" />
    <link rel="canonical" href="https://aimtti.co.in/product-category/product-accessories/aim-instrumentcases" />
    <title>Instrument Cases | Aim-TTi India</title>
        ...
        <div class="content">
            ...
            <div class="product-card">
                <div class="product-card-carousel">
                    <div class="container">
                        <div class="mySlides">
                            <img class="model-for-image cursor" data-img="<?php echo $domain ?>sites/default/files/image/large/" src="<?php echo $domain ?>sites/default/files/styles/product_medium/public/image/large/cases-250.jpg?itok=j8dTtfZJ" alt="">
                        </div>
                        ...
                        <div class="row">
                            <div class="column">
                                <img class="demo cursor" src="<?php echo $domain ?>sites/default/files/styles/product_medium/public/image/large/cases-250.jpg?itok=j8dTtfZJ" style="width:100%" onclick="currentSlide(1)" alt="">
                            </div>
                ...
                <div class="product-card-details">
                    <ul>
                        <li>Soft Case for PFM3000 handheld frequency counter</li>
                        <li>Padded travel case for PSA series spectrum analyzers</li>
                    </ul>
                </div>
            </div>
