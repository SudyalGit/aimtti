...
$title = "Power Adaptors | Aim-TTi India India";
$heading = "Power Adaptors";

$sql = "SELECT * FROM `productmodels` WHERE `ProductId` = 36";
...
<head>
    ...
    <meta name="description" content="Aim-TTi Power Adaptors AC Power Adaptors and Chargers" />
    <link rel="canonical" href="https://aimtti.co.in/product-category/product-accessories/aim-poweradaptors" />
    <title>Power Adaptors | Aim-TTi India</title>
        ...
        <div class="content">
            ...
            <div class="product-card">
                <div class="product-card-carousel">
                    <div class="container">
                        <div class="mySlides">
                            <img class="model-for-image cursor" data-img="<?php echo $domain ?>sites/default/files/image/large/" src="<?php echo $domain ?>sites/default/files/styles/product_medium/public/image/large/Adaptor-TypeB-1_0.jpg?itok=tvGOivaq" alt="">
                        </div>
                        ...
                        <div class="row">
                            <div class="column">
                                <img class="demo cursor" src="<?php echo $domain ?>sites/default/files/styles/product_medium/public/image/large/Adaptor-TypeB-1_0.jpg?itok=tvGOivaq" style="width:100%" onclick="currentSlide(1)" alt="">
                            </div>
