...
$title = "Cables and Connectors | Aim-TTi India India";
$heading = "Cables and Connectors";

$sql = "SELECT * FROM `productmodels` WHERE `ProductId` = 37";
...
<head>
    ...
    <meta name="description" content="Aim-TTi Cables and Connectors Connection and interface cables. Connector Sets." />
    <link rel="canonical" href="https://aimtti.co.in/product-category/product-accessories/aim-cablesandconnectors" />
    <title>Cables and Connectors | Aim-TTi India</title>
        ...
        <div class="content">
            ...
            <div class="product-card">
                <div class="product-card-carousel">
                    <div class="container">
                        <div class="mySlides">
                            <img class="model-for-image cursor" data-img="<?php echo $domain ?>sites/default/files/image/large/" src="<?php echo $domain ?>sites/default/files/styles/product_medium/public/image/large/cable_connectors-1.jpg?itok=nXu6pyLk" alt="">
                        </div>
                        ...
                        <div class="row">
                            <div class="column">
                                <img class="demo cursor" src="<?php echo $domain ?>sites/default/files/styles/product_medium/public/image/large/cable_connectors-1.jpg?itok=nXu6pyLk" style="width:100%" onclick="currentSlide(1)" alt="">
                            </div>
                ...
                <div class="product-card-details">
                    <ul>
                        <li>RS232 Serial Interface Cables</li>
                        <li>Connector Kit for PSA series spectrum analyzers</li>
                        <li>Component connection systems for LCR400 LCR bridge</li>
                        <li>Additional/replacement Kelvin Clip set for BS407</li>
                    </ul>
                </div>
            </div>
