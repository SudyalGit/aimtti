...
$sql = "SELECT * FROM `products` WHERE `CategoryId` = 18";
...
<head>
    ...
    <meta name="description" content="Explore legacy products that may not be current or supported anymore. Information is retained for reference and may provide links to replacement or alternative products, documentation, and downloads." />
    <link rel="canonical" href="https://aimtti.co.in/product-category/legacy-products" />
    <title>Legacy Products | Aim-TTi India</title>
    ...
    <div class="main">
        ...
        <div class="content">
            ...
            <div class="main-category-card">
                <img src="<?php echo $domain; ?>sites/default/files/category-image/legacy_temp.jpg" alt="Legacy products ">
                <p>
    ...
    <td class="image">
        <a href="">
            <img src="' . $domain . 'sites/default/files/styles/prod_cats/public/image/large/' . $product['ImageURL'] . '"
                alt="Aim-TTi India ' . $product['ProductName'] . ' Legacy Products ">
        </a>
    </td>
    <td class="details">
        <a href="">
